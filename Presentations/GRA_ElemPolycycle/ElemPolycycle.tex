...
%A \textcolor{red}{$(p,3)$-polycycle} is a plane $2$-connected locally finite graph, such that:
%\begin{itemize}
...
\begin{center}
\epsfig{file=PictureAppli/Tetrahedron.ps, height=2.0cm}\par
\end{center}
...
\overlays{2}{
\begin{slide}{$(\{3\},4)$-polycycles}
\onlySlide*{1}{
\begin{itemize}
\item Octahedron (with no hole): 
\begin{center}
\epsfig{file=PictureAppli/Octahedron.ps, height=1.2cm}\par
\end{center}
...
%\begin{slide}{Restriction operation}
%\begin{itemize}
%\item If $F$ is a face of a $(R,q)$-polycycle, then we can eliminate it and still obtain a $(R,q)$-polycycle.
%\begin{center}
%\epsfig{height=30mm, file=ElementaryDrawing/MovingFaceToHole.eps}\par
%\end{center}
%\end{itemize}
%\end{slide}
...
\begin{minipage}[b]{2.0cm}
\centering
\epsfig{file=PictureAppli/Tetrahedron.ps, width=2.0cm}\par
Tetra-\par
hedron
\end{minipage}
\begin{minipage}[b]{2.0cm}
...
\begin{minipage}[b]{2.0cm}
\centering
\epsfig{file=PictureAppli/Octahedron.ps, width=2.0cm}\par
Octa-\par
hedron
\end{minipage}
\begin{minipage}[b]{2.0cm}
\centering
\epsfig{file=PictureAppli/Icosahedron.ps, width=2.0cm}\par
Icosa-\par
hedron
\end{minipage}
\begin{minipage}[b]{2.0cm}
...
\overlays{2}{
\begin{slide}{Decomposition theorem}
\fromSlide*{1}{
\begin{itemize}
...
\begin{slide}{With at least one $2$-gon}
...
\overlays{2}{
\begin{slide}{Classification of totally elementary}
\onlySlide*{1}{
\vspace{-3mm}
Any totally elementary $(\{3,4,5\}, 3)$-polycycle is one of:
\begin{itemize}
\item three isolated $i$-gons, $i\in \{3,4,5\}$:
\begin{center}
\begin{minipage}{3cm}
\centering
...
\end{minipage}
\end{center}
\item all ten triples of $i$-gons, $i\in \{3,4,5\}$:
\begin{center}
\begin{minipage}{2cm}
\centering
...
\onlySlide*{2}{
\begin{itemize}
\item the following doubly infinite $(\{5\},3)$-polycycle, denoted by $Barrel_{\infty}$:
\begin{center}
\epsfig{height=10mm, file=ElementaryDrawing/TotalElemE_Z.eps}\par
\end{center}
\item the infinite series of $Barrel_m$, $m\geq 2$:
\begin{center}
\begin{minipage}{2.5cm}
\centering
...
\overlays{2}{
\begin{slide}{Full classification}
\onlySlide*{1}{
\vspace{-3mm}
...
\item $204$ sporadic polycycles with $4$ to $11$ proper faces
\item an element of the infinite series of $Barrel_m$, $2\leq m\leq\infty$.
\item six $(\{3,4,5\},3)$-polycycles, infinite in one direction:
\begin{center}
\begin{minipage}{5cm}
\centering
...
\onlySlide*{2}{
\begin{itemize}
\item $21={{6+1}\choose 2}$ infinite series obtained by taking two 
...
\overlays{4}{
\begin{slide}{Subcase of $(\{5\},3)$-polycycles}
\onlySlide*{1}{
%\textcolor{red}{Thm.}
Sporadic elementary $(\{5\},3)$-polycycles:
\begin{center}
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{2.9cm}{!}{\includegraphics{PictureAppli/Dodecahedron.eps}}\par
$A_1$
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
...
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{2.7cm}{!}{\includegraphics{Polycycle/Dodecahedron3vertDegTwo.ps}}\par
$A_3$
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
...
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{2.9cm}{!}{\rotatebox{90}{\includegraphics{Polycycle/PolycycleB3sec.eps}}}\par
$B_3$
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{2.8cm}{!}{\includegraphics{Polycycle/PolycycleA5.eps}}\par
$A_5$
\end{minipage}
\end{center}
}
...
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{2.0cm}{!}{\includegraphics{Polycycle/Fundamental22polycycle2.eps}}\par
$C_3$
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
...
%\end{minipage}
\end{center}
The only elementary \textcolor{red}{infinite} $(\{5\},3)$-polycycle
...
\begin{minipage}{5.0cm}
\centering
\epsfig{height=24mm, file=ElemPresPic/Barrel5.eps}\par
\end{minipage}
\begin{minipage}{5.0cm}
\centering
...
Any elementary $(\{2,3,4,5\},3)$-polycycle is one of:
\begin{itemize}
\item $57$ sporadic $(\{2,3\},5)$-polycycles.

\item three following infinite $(\{2,3\},5)$-polycycles:
\begin{center}
\begin{minipage}{1cm}
$\alpha$:
\end{minipage}
...
\vspace{-3mm}
\begin{itemize}
\item the following $5$-valent doubly infinite
...
\item the infinite series of \textcolor{red}{snub $m$-antiprisms},
...
\item six infinite series of $(\{2,3\},5)$-polycycles with one hole
...
\overlays{3}{
\begin{slide}{Subcase of $(\{3\}, 5)$-polycycles}
\onlySlide*{1}{
\begin{itemize}
\item Sporadic elementary $(\{3\}, 5)$-polycycles:
\end{itemize}
\begin{center}
\begin{minipage}{3cm}
\centering
...
\begin{minipage}{3cm}
\centering
\epsfig{width=28mm, file=ElementaryDrawing/5_val6ver_3.eps}\par
\end{minipage}
\begin{minipage}{3cm}
\centering
\epsfig{width=23mm, file=ElementaryDrawing/5_val7ver_1.eps}\par
\end{minipage}
\begin{minipage}{3cm}
\centering
\epsfig{width=28mm, file=ElementaryDrawing/5_val8ver_1.eps}\par
\end{minipage}
\begin{minipage}{3cm}
\centering
\epsfig{width=28mm, file=ElementaryDrawing/5_val9ver_1.eps}\par
\end{minipage}
\end{center}
}%
\onlySlide*{3}{
\begin{itemize}
\item The \textcolor{red}{infinite series} of elementary
...
\end{minipage}
\end{center}
\item The only elementary \textcolor{red}{infinite} $(\{3\},5)$-polycycles
...
%\begin{slide}{}
%\begin{itemize}
%\item One proves easily that for any $(r,q)$-polycycle
%\begin{equation*}
%\frac{n_{int}(P)}{f_1(P)}< \frac{r}{q}
%\end{equation*}
%\item INTERESTING STATEMENT WITHOUT PROOF. If $(r,q)$ is Euclidean then
%\begin{equation*}
%\lim_{f_{1}(P)\to\infty} \frac{n_{int}(P)}{f_{1}(P)}=\frac{r}{q}
%\end{equation*}
%\end{itemize}
%\end{slide}
...
\overlays{3}{
\begin{slide}{Small extremal $(5,3)$-polycycles}
\onlySlide*{1}{
\begin{center}
\begin{tabular}{|c|c|c|c|}
\hline
...
9     & 10&\epsfig{height=10mm, file=Polycycle/Dodecahedron3vertDegTwo.ps}&$A_3$\\[2mm]\hline
...
%\begin{array}{cccc}
%\hline
%P    &  n_{int}(P)  &  f_1(P)  &\frac{n_{int}(P)}{f_1(P)}\\
%\hline
%A_1  &  15          &11        &1.36...\\
%A_2  &  12          &10        &1.2\\
%A_3  &  10          &9         &1.11...\\
...
\overlays{2}{
\begin{slide}{Extremal $(5,3)$-polycycles}
\onlySlide*{1}{
\begin{itemize}
...
\centering
\resizebox{0.75cm}{!}{\rotatebox{270}{\includegraphics{Polycycle/PolycycleB3sec.eps}}}\par
\end{minipage}
\end{center}
...
\overlays{2}{
\begin{slide}{Finite non-extendible polycycles}
\onlySlide*{1}{
\begin{itemize}
...
\overlays{4}{
\begin{slide}{Polycycles of $(5,q)$-sphere $qR_0$}
\onlySlide*{1}{
\begin{itemize}
...
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\rotatebox{90}{\includegraphics{ElemPresPic/PolycycleA2_NO.eps}}}\par
NO
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/Dodecahedron3vertDegTwo_NO.eps}}\par
NO
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/PolycycleA4_NO.eps}}\par
NO
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\rotatebox{90}{\includegraphics{ElemPresPic/PolycycleB3_NO.eps}}}\par
NO
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/PolycycleA5_NO.eps}}\par
NO
\end{minipage}
\end{center}
}
...
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/Fundamental22polycycle3_YES.eps}}\par
\textcolor{blue}{YES}
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/PolycycleB2_NO.eps}}\par
NO
\end{minipage}
\begin{minipage}{3.7cm}
\centering
...
\begin{minipage}{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{ElemPresPic/Fundamental22polycycle2_YES.eps}}\par
\textcolor{blue}{YES}
\end{minipage}
\begin{minipage}{3.7cm}
\centering
\resizebox{2.0cm}{!}{\rotatebox{180}{\includegraphics{ElemPresPic/PolycycleD_NO.eps}}}\par
NO
\end{minipage}
...
\begin{slide}{Results}
\onlySlide*{1}{
For a $(5,q)$-sphere $qR_0$, the gonality of faces of the $3$-valent map $Maj(G)$ is at most $\lfloor \frac{q}{2}\rfloor$.
\begin{itemize}
...
\onlySlide*{2}{
For $q<12$, we have a finite number of $(5,q)$-spheres $qR_0$.
\begin{itemize}
