...
\centering
\epsfig{file=DRAW/PS/C60.ps, height=40mm}\par
...
\begin{minipage}[b]{5.5cm}
\centering
\epsfig{file=GOLDBERGpicture/c60Sec.ps,height=45mm}\par
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{46mm}{!}{\includegraphics{DRAW/PS/embeddingofF20.ps}}\par
%Dodecahedron\par
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{42mm}{!}{\rotatebox{0}{\includegraphics{FullPresPic/OtherReg2.eps}}}\par
...
\begin{minipage}[b]{2.7cm}
\centering
\resizebox{25mm}{!}{\includegraphics{FullPresPic/Picture2.eps}}\par
26, $D_{3h}$
\end{minipage}
\begin{minipage}[b]{2.7cm}
\centering
\resizebox{25mm}{!}{\includegraphics{FullPresPic/Picture3.eps}}\par
28, $D_{2}$
\end{minipage}
\begin{minipage}[b]{2.7cm}
\centering
...
\begin{minipage}[b]{2.7cm}
\centering
\resizebox{25mm}{!}{\includegraphics{FullPresPic/Picture5.eps}}\par
30, $D_{5h}$
\end{minipage}
\begin{minipage}[b]{2.7cm}
\centering
\resizebox{25mm}{!}{\includegraphics{FullPresPic/Picture6.eps}}\par
30, $C_{2v}$
\end{minipage}
\begin{minipage}[b]{2.7cm}
\centering
\resizebox{25mm}{!}{\includegraphics{FullPresPic/Picture7.eps}}\par
30, $D_{2v}$
\end{minipage}
\end{center}
\end{slide}
...
\centering
\resizebox{7.1cm}{!}{\rotatebox{90}{\includegraphics{FullPresPic/Fig.eps}}}\par
\end{minipage}
\end{center}
\end{slide}
...
%\resizebox{2.8cm}{!}{\includegraphics{DRAW/PS/kepler1.ps}}
%\end{minipage}
%\begin{minipage}[t]{3.5cm}
%\resizebox{2.8cm}{!}{\includegraphics{DRAW/PS/kepler2.ps}}
%\end{minipage}
%\begin{minipage}[t]{3.5cm}
%\resizebox{2.8cm}{!}{\includegraphics{DRAW/PS/kepler3.ps}}
%\end{minipage}
%\begin{minipage}[t]{3.5cm}
%\resizebox{2.8cm}{!}{\includegraphics{DRAW/PS/kepler4.ps}}
%\end{minipage}
%\begin{minipage}[t]{3.5cm}
%\resizebox{2.8cm}{!}{\includegraphics{DRAW/PS/kepler5.ps}}
%\end{minipage}
%\end{center}
%\end{slide}
...
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/C60.ps}}\par
$C_{60}(I_h)$=$(1,1)$-dodecahedron\\
truncated icosahedron
\end{minipage}
\begin{minipage}{5.5cm}
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/C80.ps}}\par
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/embeddingofdualC60.ps}}\par
Dual $C_{60}^{*}(I_h)$, $(a,b)=(1,1)$\\
pentakis-dodecahedron
\end{minipage}
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/escher.ps}}\par
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/heche2dode.ps}}\par
%$C_{80}^*(I_h)$,  $(a,b)$=$(2,0)$
%\end{minipage}
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/cox140.ps}}\par
%$C_{140}^*(I)$,  $(a,b)$=$(2,1)$
%\end{minipage}
%\end{center}
%\end{slide}
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/cox180.ps}}\par
%$C_{180}^*(I_h)$, $(a,b)=(3,3)$\\
%\textcolor{white}{Bonjour}
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/etoile1.ps}}\par
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/heche4octa.ps}}\par
Dual $4$-chamfered cube \par
$(a,b)=(16,0)$, $O_h$
\end{minipage}
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/heche4dode.ps}}\par
Dual $4$-cham.
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{4.5cm}{!}{\includegraphics{DRAW/PS/aids.ps}}\par
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/virus.ps}}\par
...
%\begin{minipage}[b]{5.5cm}
%\centering
%graphite: \resizebox{2.7cm}{!}{\includegraphics{DRAW/PaperTerrones/P342_1_a.eps}}
%\end{minipage}
%\begin{minipage}[b]{5.5cm}
%\centering
%diamond: \resizebox{2.7cm}{!}{\includegraphics{DRAW/PaperTerrones/P342_1_b.eps}}
%\end{minipage}
%\end{center}
%}
%\end{slide}
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{5.1cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic3.eps}}\par
%La\@$C_{82}$\\
...
%\begin{minipage}{8.5cm}
%\centering
%\resizebox{7.1cm}{!}{\includegraphics{DRAW/PaperTerrones/P349_13.eps}}\par
%\end{minipage}
%\end{center}
%\begin{center}
...
%\begin{minipage}{8.5cm}
%\centering
%\resizebox{3.5cm}{!}{\includegraphics{DRAW/PS/russia.ps}}\par
...
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{4.9cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic1.eps}}\par
%Helical graphite
%\end{minipage}
%\begin{minipage}[b]{5.5cm}
%\centering
%\resizebox{4.1cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic2.eps}}\par
...
%$Au_n=F^{*}_{2n-4}$ ($16 \le n \le18$). $F^{*}_{24}$ is the smallest; 
%the gold 
%clusters are 
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{4.5cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic6.eps}}\par
%\textcolor{white}{Bonjour}\\
%\textcolor{white}{Bonjour}
\end{minipage}
\hspace{0.1cm}
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.5cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic5.eps}}\par
...
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.3cm}{!}{\includegraphics{FullPresPic/pcube.8.eps}}\par
Schwarz $P$-surface
\end{minipage}
\begin{minipage}[b]{5.5cm}
\centering
\resizebox{3.3cm}{!}{\includegraphics{FullPresPic/drhomb.8.eps}}\par
Schwarz $D$-surface
\end{minipage}
\end{center}
...
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic10.eps}}\par
$(1,1)$\par
$D168$: putative carbon, 1992, (Vanderbilt-Tersoff)
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{3.2cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic11.eps}}\par
$(0,2)$\\
\textcolor{white}{Bonjour}
\end{minipage}
\begin{minipage}[b]{3.7cm}
...
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{3.0cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic7.eps}}\par
$(1,1)$\\
\textcolor{white}{Bonjour}
\end{minipage}
\begin{minipage}[b]{3.7cm}
\centering
\resizebox{3.2cm}{!}{\includegraphics{DRAW/ScanDezaPres/pic8.eps}}\par
$(0,2)$\par
$P192$, $p_6=80$
\end{minipage}
\begin{minipage}[b]{3.7cm}
