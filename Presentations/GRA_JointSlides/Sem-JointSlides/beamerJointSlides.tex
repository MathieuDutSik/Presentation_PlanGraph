...
\end{itemize}
%\textcolor{blue}{Theorem}: above spheres are only non-polyhedral ones   
%among  all $4$ standard $(\{a,b\},k)$-spheres with $b>a\ge 3$.
...
\begin{minipage}[b]{30mm}
\centering
\resizebox{26mm}{!}{\includegraphics{PicJointSlides/SeqG2.pdf}}\par
\end{minipage}
\begin{minipage}[b]{30mm}
\centering
\resizebox{26mm}{!}{\includegraphics{PicJointSlides/SeqG3.pdf}}\par
\end{minipage}
\end{center}
...
\centering
\resizebox{20mm}{!}{\includegraphics{PicJointSlides/4-hedrite2_1.pdf}}\par
...
\centering
\resizebox{24mm}{!}{\includegraphics{PicJointSlides/4-hedrite4-2.pdf}}\par
$D_{2h}$ 
...
\begin{minipage}[b]{24mm}
\centering
\resizebox{20mm}{!}{\includegraphics{PicJointSlides/4-hedrite6_1sec.pdf}}\par
%\textcolor{blue}{$6^2_2$}  
...
\begin{minipage}[b]{23mm}
\centering
\resizebox{19mm}{!}{\includegraphics{PicJointSlides/8-hedrite10_1sec.pdf}}\par
...
\begin{minipage}[b]{24mm}
\centering
\resizebox{20mm}{!}{\includegraphics[bb=1 1 457 464,
...
\begin{tabular*}{7cm}{c}
\\[-0.5cm]
{\Huge \textcolor{blue}{V. }\textcolor{red}{Symmetry groups  of}}
\\[4mm]{\Huge \textcolor{red}{$(\{a,b\},k)$-spheres}
}
\end{tabular*}
\end{center}
...
\begin{tabular*}{7cm}{c}
\\[-0.5cm]
{\Huge \textcolor{blue}{VI. }\textcolor{red}{Goldberg-Coxeter}}
...
\begin{tabular*}{7cm}{c}
\\[-0.5cm]
{\Huge \textcolor{blue}{VII. }\textcolor{red}{Parameterizing}}
\\[4mm]{\Huge \textcolor{red}{$(\{a,b\},k)$-spheres}
}
\end{tabular*}
\end{center}
...
\begin{tabular*}{8cm}{c}
\\[-0.7cm]
{\Huge \textcolor{blue}{VIII. }\textcolor{red}{Railroads and tight}}
...
$\{5,6\}_{172}(C_{3v})$
%\\ \textcolor{blue}{Conjecture:} It is smallest such $5_n$ graph.
\end{minipage}
\end{center}
...
$\{2,4\}_{2}(D_{4h})$ with
%Besides \textcolor{red}{$\{2,3\}_{44}(D_{3h})$},
...
\begin{tabular*}{7cm}{c}
\\[-0.5cm]
{\Huge \textcolor{blue}{IX. }\textcolor{red}{Tight pure}}
\\[4mm]{\Huge \textcolor{red}{$(\{a,b\},k)$-spheres}
}
\end{tabular*}
\end{center}
...
%Such ZC-circuit can be seen as a \textcolor{red}{Jordan curve}, i.e. a 
%plane curve which is topologically equivalent to (a 
...
%all with $\frac{v}{4}$ prime 
%$all with $3$ zigzags 
%\item[\ding{108}] all with $2$ central circuits for 
...
$G$. 
%The faces of it are the same as of $G$ plus $|X|$ disjoint triangles.
...
\begin{minipage}{2.3cm}
\centering
\resizebox{2.1cm}{!}{\includegraphics{PicJointSlides/Tight60_Ihsec.pdf}}\par
...
%The groups of $1,4,6,8$th are \textcolor{blue}{zigzag-transitive}.
\end{frame}
...
curve.
%which istopologically equivalent to (a homeomorphic image of) the unit circle.
\item
%\textcolor{red}{Gr\H{u}nbaum}  
...
%All semi-regular polyhedra are \textcolor{blue}{$z$-uniform}.  
 \item The medials of truncated 
Tetrahedron, Cube, Icosahedron, Dodecahedron  
%($F_{60}(I_h)$), Trunc. Tetrahedron, Tr. 
...
\begin{tabular*}{7cm}{c}
\\[-5mm]   
{\Huge \textcolor{blue}{X. }\textcolor{red}{Other fullerene analogs:}}
...
%++$\frac{1}{\max_{i\in R}i}$$<$$\frac{1}{2}$ are:
\begin{itemize}
...
%(incl. usual fullerenes: case $c\in\{5,6\}$) is 
is polyhedral.

\textcolor{blue}{Conjecture} (checked for $c\le 20$):
%1) $2(c$+$11)$-vertex \textcolor{blue}{$c$-pentatube} is the
...
%\begin{frame}\frametitle{Fullerene $c$-disks: big 
%picture}\vspace{-2mm}\begin{itemize}
%\item \textcolor{red}{Conjecture}: following
%($(5c$-$5)$- or $(5c$-$6)$-vertex for odd or even $c\ge 5$) $c$-thimble 
%is a minimal one; it holds for $5$$\le$$ c $$\le $$10$.
%Take the $c$-ring of $5$-gons,  then put inside a concentric $c$-ring of
%($5$-or-$6$)-gons: $3$-path of $5$-gons and, on opposite side,
%$3$-path or $3$-ring, for even or odd $c$, of $5$-gons.
%Remaining $c$-$6$ or $c$-$5$ ($5$-or-$6$)-gons
%of interior $c$-ring are $6$-gons.
%Finally, fill inside of the interior $c$-ring by the $\frac{c-4}{2}$-
%or $\frac{c-5}{2}$-path of $6$-gons.

%\item \textcolor{red}{Conjecture} (checked for $c\le 20$):

%1) $2(c$+$11)$-vertex $c$-pentatube is the
%minimal $c$-disk if $c$$\ge $$13$.

%2) $v$-vertex $c$-disk
% exists iff $\frac{v}{2}$$\ge$$p(c)$+$c$+$5$, integer,
%unless $(c,v)$=$(1,42),(3,24),(5,22)$; $p(c)$ is minimal $p_6$ in $c$-disk.
%Now, $p(c)$=$14,6,3,2,0,1,3,4,6,7,8,5$ for $1\le c\le 12$ and =$6$ for $c\geq 13$.
%For $c\leq 20$, it was checked by computation.
%\end{itemize}\end{frame}

%\begin{frame}\frametitle{}\vspace{-2mm}\begin{itemize}
%\end{itemize}\end{frame}
...
%For $c\leq 20$, it was checked by computation
%For $1$$\le$$ c$$\le$$ 8$, they
%minimal $c$-disks are unique  and  $p_6$=$14,6,3,2,0,1,3,4$.
%\end{itemize}
%Dodecahedron.
...
%\begin{itemize}
%\item There are
%$2,3,10$ minimal $c$-disks 
%for $c$=$9,10,11$ and $1$, otherwise; checked for $c$$\le$$20$.
%\textcolor{red}{Conjecture}: for $c\ge 13$, the only
%minimal $c$-disk  is \textcolor{red}{$c$-pentatube} 
%$B$+$Hex_3$$+$$Pen_{c-12}$+$Hex_3$+$B$ (symmetry $C_s/C_2$ for odd/even $c$).
...
\begin{tabular*}{7cm}{c}
\\[-5mm]
{\Huge \textcolor{blue}{XI. }\textcolor{red}{Icosahedrites:}}
...
\begin{tabular*}{9cm}{c}
\\[-8mm]
{\Huge \textcolor{blue}{XII. }\textcolor{red}{Standard 
$(\{a,b\},k)$-maps}}
\\[4mm]{\Huge \textcolor{red}{on surfaces}
}
\end{tabular*}
\end{center}
}
...
\begin{tabular*}{7cm}{c}
\\[-0.5cm]
{\Huge \textcolor{blue}{XIII. }\textcolor{red}{Beyond  surfaces}}
