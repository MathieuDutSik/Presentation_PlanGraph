...
\centering
\mbox{
\subfigure[The case $t=1$, $t'=1$]{\epsfig{figure=Case3-3.eps,width=.20\textwidth}}
\subfigure[The Case $t=2$, $t'=2$]{\epsfig{figure=Case2-2.eps,width=.27\textwidth}}
\subfigure[The case $t=2$, $t'=1$]{\epsfig{figure=InfiniteStructure.eps,width=.27\textwidth}}
}
...
\begin{figure}
\centering
\mbox{\subfigure[The two cases for $6$-hedrite]{\epsfig{figure=PossibilitiesTwo.eps,width=.25\textwidth}}\quad
\subfigure[The three cases for $5$-hedrite]{\epsfig{figure=PossibilitiesThree.eps,width=.25\textwidth}}\quad
\subfigure[The two case for $4$-hedrite]{\epsfig{figure=PossibilitiesFour.eps,width=.25\textwidth}}}
...
Figure \epsfbox{PurityFourCentral.eps}
