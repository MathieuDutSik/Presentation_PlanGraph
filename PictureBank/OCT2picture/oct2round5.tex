...
All possibilities are presented on picture below:
!!give the number of this Figure!!
two for $i=6$, three for $i=5$ and two for $i=4$. In the last case, there are no $3$-gons and so, simple circuits in the curvature graph contain only even number of $2$-gons by local Euler formula 
(\ref{Local-Euler-Formula})!!no such \ref!!.
...
pair of $2$-gons. 
!!%Remark that not all possible values of the shift are possible.
