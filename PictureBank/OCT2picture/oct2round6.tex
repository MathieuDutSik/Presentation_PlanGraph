...
\centering
\mbox{
\subfigure[The first case]{\epsfig{figure=CuttingFirstCase.eps,width=.30\textwidth}}
\subfigure[The second case]{\epsfig{figure=CuttingSecondCase.eps,width=.20\textwidth}}
}
...
exists 
%!!if and only if $n \ge 7$, except $8$ and $9$.
